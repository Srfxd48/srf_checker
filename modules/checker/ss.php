    ...
    if($antispam != False){
      ...
      return;
        ...
        if(preg_match_all("/(\d{16})[\/\s:|]*?(\d\d)[\/\s|]*?(\d{2,4})[\/\s|-]*?(\d{3})/", $lista, $matches)) {
            ...
            curl_setopt($ch, CURLOPT_PROXY, $url[array_null($url)]);
...
<b>Bot By: <a href='t.me/srfxd'>srfxd</a></b>",
                'parse_mode'=>'html',
...
<b>Checked By <a href='tg://user?id=$userId'>$firstname</a></b>
<b>Bot By: <a href='t.me/srfxd'>sharif xd</a></b>",
                'parse_mode'=>'html',
                'disable_web_page_preview'=>'true'
